...
ALTER TABLE addon_activities ALTER COLUMN id SET DEFAULT nextval('addon_activities_id_seq'::regclass);
...
ALTER TABLE addonships ALTER COLUMN id SET DEFAULT nextval('addonships_id_seq'::regclass);
