...
describe FileHeader do
  ...
  describe ".content_type" do
    it "set content-type to text/javascript for .js files" do
      described_class.content_type('foo.js').should eq 'text/javascript'
    end

    it "set content-type to text/javascript for .jgz files" do
      described_class.content_type('foo.jgz').should eq 'text/javascript'
    end

    it "automatically set content-type for other files" do
