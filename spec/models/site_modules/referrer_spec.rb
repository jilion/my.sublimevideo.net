...
describe SiteModules::Referrer do
  ...
  describe "#referrer_type" do
    ...
    context "without wildcard or path" do
      before(:all) do
        @site = FactoryGirl.create(:site, hostname: "jilion.com", extra_hostnames: 'jilion.org, staging.jilion.com', dev_hostnames: "jilion.local, localhost, 127.0.0.1")
      end
      subject { @site }
    ...
    context "with hostname with subdomain" do
      before(:all) do
        @site = FactoryGirl.create(:site, hostname: "blog.jilion.com", extra_hostnames: nil, dev_hostnames: nil)
      end
      subject { @site }
    ...
    context "with wildcard" do
      before(:all) do
        @site = FactoryGirl.create(:site, hostname: "jilion.com", extra_hostnames: 'jilion.org, jilion.net', dev_hostnames: "jilion.local, localhost, 127.0.0.1", wildcard: true)
      end
      subject { @site }
    ...
    context "with path" do
      before(:all) do
        @site = FactoryGirl.create(:site, hostname: "jilion.com", extra_hostnames: 'jilion.org, staging.jilion.com', dev_hostnames: "jilion.local, localhost, 127.0.0.1", path: "demo/boo")
      end
      subject { @site }
    ...
    context "with wildcard and path" do
      before(:all) do
        @site = FactoryGirl.create(:site, hostname: "jilion.com", extra_hostnames: 'jilion.org, jilion.net', dev_hostnames: "jilion.local, localhost, 127.0.0.1", path: "demo", wildcard: true)
      end
      subject { @site }
    ...
    context "custom" do
      before(:all) { @site = FactoryGirl.create(:site, hostname: "capped.tv", path: "lft-turbulence|mq") }
