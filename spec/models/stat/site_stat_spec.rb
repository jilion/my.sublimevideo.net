...
describe Stat::SiteStat do
  ...
  describe ".json" do
    ...
    describe "with seconds period (missing value not filled)" do
      subject { JSON.parse(Stat::SiteStat.json(@site.token, 'seconds')) }
    ...
    describe "with minutes period" do
      subject { JSON.parse(Stat::SiteStat.json(@site.token, 'minutes')) }
    ...
    describe "with hours period" do
      subject { JSON.parse(Stat::SiteStat.json(@site.token, 'hours')) }
    ...
    describe "with days period" do
      subject { JSON.parse(Stat::SiteStat.json(@site.token, 'days')) }
