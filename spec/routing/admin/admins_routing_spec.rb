...
describe Admin::AdminsController do
  ...
  it { put(with_subdomain('admin', 'admins/1')).should route_to('admin/admins#update', id: '1') }
  it { put(with_subdomain('admin', 'admins/1/reset_auth_token')).should route_to('admin/admins#reset_auth_token', id: '1') }
