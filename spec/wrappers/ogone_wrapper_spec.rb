  ...
  context "with visa credit card" do
    ...
    describe ".store" do
      describe "store of $0.01 with alias" do
        ...
        subject { OgoneWrapper.store(cc, currency: 'USD', billing_id: 'sublime_33') }
    ...
    describe ".purchase" do
      describe "payment of $10" do
        ...
        subject { OgoneWrapper.purchase(1000, cc, currency: 'USD') }
      ...
      describe "payment of $20 via alias" do
        ...
        subject { OgoneWrapper.purchase(2000, 'sublime_33', currency: 'USD') }
      ...
      describe "payment of $9999" do
        ...
        subject { OgoneWrapper.purchase(999900, cc, currency: 'USD') }
      ...
      describe "payment of €20" do
        ...
        subject { OgoneWrapper.purchase(2000, cc, currency: 'EUR') }
      ...
      describe "payment of $10000" do
        ...
        subject { OgoneWrapper.purchase(1000000, cc, currency: 'USD') }
    ...
    describe ".refund" do
      describe "refund of $10 via a transaction's pay_id that succeeds" do
        before do
          VCR.use_cassette "ogone/visa_payment_generic" do
            @purchase = OgoneWrapper.purchase(1000, cc, currency: 'USD')
          end
        end
        subject { OgoneWrapper.refund(1000, @purchase.authorization) }
      ...
      describe "refund of $10 via a transaction's pay_id that fails" do
        ...
        subject { OgoneWrapper.refund(3000, @purchase.authorization) } # amount bigger than the original sale
  ...
  context "with master credit card" do
    ...
    describe ".purchase" do
      describe "payment of $100" do
        ...
        subject { OgoneWrapper.purchase(10000, cc, currency: 'USD') }
