  ...
  context "with a logged in user" do
    ...
    describe "GET :index" do
      it "should render :index with 'application' layout" do
        @current_user.stub_chain(:sites, :find_by_token).and_return(mock_site)
    ...
    describe "GET :show" do
      it "should render :show" do
        @current_user.stub_chain(:invoices, :find_by_reference).with('QWE123TYU').and_return(mock_invoice)
