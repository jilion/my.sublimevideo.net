MySublimeVideo::Application.routes.draw do
  ...
  namespace "admin" do
    ...
    scope "mails", :module => "mails" do
      resources :templates, :only => [:new, :create, :edit, :update], :as => 'mail_templates'
...
#== Route Map
# Generated on 29 Sep 2010 15:45
#
...
#                    root        /(.:format)                            {:to=>#<Proc:0x0000010364a560@/Users/Thibaud/.rvm/gems/ruby-1.9.2-p0/gems/actionpack-3.0.0/lib/action_dispatch/routing/mapper.rb:284 (lambda)>}
#                   admin        /admin(.:format)                       {:action=>"admin", :to=>#<Proc:0x00000103637168@/Users/Thibaud/.rvm/gems/ruby-1.9.2-p0/gems/actionpack-3.0.0/lib/action_dispatch/routing/mapper.rb:284 (lambda)>}
