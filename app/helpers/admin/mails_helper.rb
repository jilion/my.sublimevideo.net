module Admin::MailsHelper
  ...
  def mails_criteria
    ...
    grouped_criteria['User Type'] << ["With sites with the 'Your logo' add-on out of beta after Feb 20th WITH CREDIT CARD (#{display_integer(User.with_cc.in_beta_trial_ended_after('logo-custom', Time.utc(2013, 2, 20)).size)})", "without_cc.in_beta_trial_ended_after('logo-custom', Time.utc(2013, 2, 20))"]
