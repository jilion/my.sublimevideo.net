class Admin::DashboardsController < Admin::AdminController
  ...
  def show
    ...
    last_30_days_billable_video_views = SiteStat.views_sum

    @last_30_days_video_views = SiteStat.views_sum(from: 31.days.ago.utc, to: Time.now.utc.yesterday)
    @total_video_views = SiteStat.views_sum # all time views sum! FUCK YEAH!
  end
