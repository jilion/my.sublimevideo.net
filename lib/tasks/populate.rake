...
namespace :db do
  ...
  namespace :populate do
    ...
    task empty_all_tables: :environment do
      timed { Populate.empty_tables("delayed_jobs", "invoices_transactions", DealActivation, Deal, InvoiceItems::InvoiceItem, Invoice, Transaction, Log, MailTemplate, MailLog, Site, SiteUsage, User, Admin, Plan) }
    end
