...
class HAPIConnection
  ...
  def call_method( request, auth_info = {} )
    raise Argument, "You must pass a HAPIRequest object to HAPIConnection#call_method" unless request.is_a?(HAPIRequest)
    ...
    when Net::HTTPSuccess, Net::HTTPRedirection
      ...
      HAPIResponse.new :raw_xml => response.body, :debug => @debug
