...
class HAPI
  ...
  def initialize(options = {})
    ...
    begin
      @connection = HAPIConnection.new :hapi_hostname => @hapi_hostname, :hapi_version => @hapi_version, :debug => @debug
  ...
  def request_method( method_name, options = {}, use_auth = false, xml_options = {}, output_options = {} )
    ...
    begin
      request = HAPIRequest.new :hapi_username => @hapi_username,
    ...
    rescue HAPIConnection::Error => ex
      raise ex, ex.message
    end
  end
